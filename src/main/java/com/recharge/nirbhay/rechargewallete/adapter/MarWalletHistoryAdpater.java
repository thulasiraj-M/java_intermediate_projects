...
public class MarWalletHistoryAdpater extends ArrayAdapter<String> {
	...
	public MarWalletHistoryAdpater(Activity context, FragmentManager fmg, ArrayList<String>ArrIdtxt, ArrayList<String>Arruidtxt, ArrayList<String>Arrmobtxt, ArrayList<String>Arramounttxt) {
